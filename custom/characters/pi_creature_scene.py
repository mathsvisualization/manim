...
from custom.characters.pi_creature import Carlo
...
class TeacherStudentsScene(PiCreatureScene):
    student_colors: list[ManimColor] = [MATHS_COLOR, PURPLE_B, PURPLE_A]
    teacher_color: ManimColor = BLUE
    ...
    def create_pi_creatures(self):
        self.teacher = Carlo(color=self.teacher_color)
